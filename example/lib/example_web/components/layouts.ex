    ...
    <header class="navbar px-4 sm:px-6 lg:px-8 border-b border-base-200">
      <div class="flex-1">
        <a href="/" class="flex items-center gap-2">
          ...
          <span class="text-sm font-semibold">AshIntegration Example</span>
        </a>
      </div>
      <div class="flex-none">
        <ul class="flex flex-column px-1 space-x-2 items-center">
          <li>
            <a href={~p"/integrations"} class="btn btn-ghost btn-sm">Integrations</a>
          </li>
          <li>
            <.theme_toggle />
          </li>
          <%= if @current_user do %>
            <li>
              <span class="text-sm text-base-content/70">{@current_user.email}</span>
            </li>
            <li>
          ...
          <% else %>
            <li>
              <a href={~p"/sign-in"} class="btn btn-ghost btn-sm">Sign in</a>
            </li>
            <li>
